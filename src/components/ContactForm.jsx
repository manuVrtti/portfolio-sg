...
export default function ContactForm() {
  ...
  return (
    <form
      ...
      aria-label="Send a message to Suyash"
    >
      ...
      {status === 'success' && (
        ...
        >
          Thank you! Your message was transmitted successfully. Suyash will respond within 24 hours.
        </div>
      )}
      ...
      {status === 'error' && (
        ...
        >
          Something went wrong. Please try again or email directly at contactsuyashgupta@gmail.com
        </div>
      )}
